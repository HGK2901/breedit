...
const Testinomials = () => {
  return (
    <div>
        <section className="text-gray-600 body-font bg-[#c88572] rounded-3xl md:m-0 lg:m-16 mt-0 lg:rounded-3xl md:rounded-none blogCard">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div className="h-full text-center">
          ...
          <p className="leading-relaxed">TESTIONALS cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
